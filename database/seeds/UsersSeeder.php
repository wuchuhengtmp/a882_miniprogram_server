...
class UsersSeeder extends Seeder
{
    ...
    public function run()
    {
        db::insert('insert into `users` (`id`, `username`, `email`, `email_verified_code`, `email_verified_at`, `password`, `nickname`, `phone`, `address`, `tags`, `rate`, `start_time`, `end_time`, `latitude`, `longitude`, `region_id`, `is_disable`, `remember_token`, `created_at`, `updated_at`) values (\'1\', \'admin\', null, null, null, \'$2y$10$dmiv2xdfz755wlr5rg9.wou7o4ygqokq9vm7xxoxxfrahkl4hotkc\', \'系统管理员\', null, null, null, \'0\', null, null, null, null, null, \'1\', null, null, null);');
